          ...
          <div className="w-full">
            ...
            <div className="w-full grid lg:grid-cols-3 sm:grid-cols-2 gap-5 mt-8">
              ...
              <div>
                ...
                <h3 className="text-tertiary-1 font-bold capitalize">{getRequestTypeName(requestDetails?.request_type_id) || "N/A"}</h3>
              </div>

              <div>
                <h3 className="uppercase font-bold text-primary-1 text-xs mb-1">data category</h3>
                <h3 className="text-tertiary-1 font-bold capitalize">{getRequestCategoryName(requestDetails?.category_id) || "N/A"}</h3>
              </div>
              ...
              <div className="w-[70%] h-[20%]">
                <h3 className="uppercase font-bold text-primary-1 text-xs mb-1">Data File</h3>

                {requestDetails?.data_file ? (
                    <div className="my-4">
                        <a
                            href={requestDetails.data_file}
                            download
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center px-4 py-2 bg-primary-1 text-white rounded-md shadow hover:bg-primary-1 transition"
                        >
                            Download File
                        </a>
                    </div>
